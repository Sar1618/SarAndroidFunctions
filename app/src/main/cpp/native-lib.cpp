...
Java_com_sar_sarandroidfunctions_OpenSLESActivity_startPlay(JNIEnv *env, jobject instance) {
    // 创建引擎
...
// 停止播放音频
JNIEXPORT void JNICALL
Java_com_sar_sarandroidfunctions_OpenSLESActivity_stopPlay(JNIEnv *env, jobject instance) {
    if (playerPlay != NULL) {
        SLresult result;
...
// 开始采集音频数据，并保存到本地
JNIEXPORT void JNICALL
Java_com_sar_sarandroidfunctions_OpenSLESActivity_startRecord(JNIEnv *env, jobject instance) {
    ...
    result = (*recorderBuffQueueItf)->Enqueue(recorderBuffQueueItf, recorderContext->buffer,
                                              BUFFER_SIZE);
    assert(SL_RESULT_SUCCESS == result);
...
// 停止音频采集
JNIEXPORT void JNICALL
Java_com_sar_sarandroidfunctions_OpenSLESActivity_stopRecord(JNIEnv *env, jobject instance) {
...
// 释放资源
JNIEXPORT void JNICALL
Java_com_sar_sarandroidfunctions_OpenSLESActivity_release(JNIEnv *env, jobject instance) {
    if (recorderObject != NULL) {
